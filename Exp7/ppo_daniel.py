    ...
    def learn(self, total_timesteps):
        ...
        while t_so_far < total_timesteps:
            ...
            if i_so_far % self.save_freq == 0:
                torch.save(self.actor.state_dict(), './ppo_actor_exp7.pth')
                torch.save(self.critic.state_dict(), './ppo_critic_exp7.pth')
    ...
    def rollout(self):
        ...
        while t < self.timesteps_per_batch:
            ...
            for ep_t in range(self.max_timesteps_per_episode+1):    #+1
                ...
                daction, caction, log_probd, log_probc = self.get_action(prev_m, mask_vec)
                val = self.critic(prev_m)
